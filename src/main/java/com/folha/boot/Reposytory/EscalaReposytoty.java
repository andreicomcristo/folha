...
public interface EscalaReposytoty extends JpaRepository<Escala, Long> {
	...
	//Buscar Escala Colaborador
		...
		public List<Escala> findByIdFuncionarioFkAndIdAnoMesFkAndDtCancelamentoIsNullOrderByIdCoordenacaoFkIdLocalidadeFkIdUnidadeFkAscIdTipoFolhaFkAscIdFuncionarioFkIdPessoaFkNomeAsc (PessoaFuncionarios funcionario, AnoMes anoMes);
