...
@Entity
@Table(name = "pessoa_complemento_de_plantao_sede")
public class PessoaComplementoDePlantaoSede extends AbstractEntity<Long> {
    ...
    public PessoaComplementoDePlantaoSede() {
    }
