...
@Entity
@Table(name = "faixas_valores_parametros_calculo_folhas_extras_individual")
public class FaixasValoresParametrosCalculoFolhasExtrasIndividual extends AbstractEntity<Long> {
    ...
    public FaixasValoresParametrosCalculoFolhasExtrasIndividual() {
    }
