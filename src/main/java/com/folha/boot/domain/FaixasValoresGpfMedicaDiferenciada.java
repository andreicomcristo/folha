...
@Entity
@Table(name = "faixas_valores_gpf_medica_diferenciada")
public class FaixasValoresGpfMedicaDiferenciada extends AbstractEntity<Long> {
    ...
    public FaixasValoresGpfMedicaDiferenciada() {
    }
