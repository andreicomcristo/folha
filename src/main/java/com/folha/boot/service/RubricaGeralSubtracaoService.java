...
public class RubricaGeralSubtracaoService {
	...
	public void editar(RubricaGeralSubtracao rubricaGeralSubtracao) {
		// TODO Auto-generated method stub
		reposytory.save(rubricaGeralSubtracao);
	}
	...
	public ByteArrayInputStream exportarPdf(List<RubricaGeralSubtracao> lista) {
		...
		try {
			...
			PdfPCell cellTitulo;
			cellTitulo = new PdfPCell(new Phrase("Rubrica GEral Subtração", tituloFont) );
