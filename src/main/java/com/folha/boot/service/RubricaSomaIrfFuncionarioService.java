...
import com.folha.boot.Reposytory.RubricaSomaIrfFuncionarioReposytory;
...
public class RubricaSomaIrfFuncionarioService {

	@Autowired
	private RubricaSomaIrfFuncionarioReposytory reposytory;
	
	@Autowired
	private AnoMesService anoMesService;
	

	public void salvar(RubricaSomaIrfFuncionario rubricaSomaIrfFuncionario) {
		// TODO Auto-generated method stub
		reposytory.save(rubricaSomaIrfFuncionario);
	}

	public void editar(RubricaSomaIrfFuncionario rubricaSomaIrfFuncionario) {
		// TODO Auto-generated method stub
		reposytory.save(rubricaSomaIrfFuncionario);
	}
	...
	public RubricaSomaIrfFuncionario buscarPorId(Long id) {
		// TODO Auto-generated method stub
		return reposytory.findById(id).get();
	}

	@Transactional(readOnly = true)
	public List<RubricaSomaIrfFuncionario> buscarTodos() {
		// TODO Auto-generated method stub
		return reposytory.findAllByOrderByIdAnoMesFkNomeAnoMesDesc();
	}
	
	@Transactional(readOnly = true)
	public List<RubricaSomaIrfFuncionario> buscarPorMesExato(AnoMes anoMes) {
		return reposytory.findByIdAnoMesFkOrderByIdAnoMesFkNomeAnoMesDesc(anoMes);
	}
	
	@Transactional(readOnly = true)
	public List<RubricaSomaIrfFuncionario> buscarPorNome(String nome) {
		return reposytory.findByIdAnoMesFkNomeAnoMesContainingOrderByIdAnoMesFkNomeAnoMesDesc(nome);
	}
	
	public Page<RubricaSomaIrfFuncionario> findPaginated(int pageNo, int pageSize) {
		Pageable pageable = PageRequest.of(pageNo -1, pageSize);
		return this.reposytory.findAllByOrderByIdAnoMesFkNomeAnoMesDesc(pageable);
	}

	public Page<RubricaSomaIrfFuncionario> findPaginatedAnoMes(int pageNo, int pageSize, String nome) {
		Pageable pageable = PageRequest.of(pageNo -1, pageSize);
	...
	public boolean avaliarCadastrado( RubricaSomaIrfCodigo rubricaSomaIrfCodigo, AnoMes anoMes, PessoaFuncionarios PessoaFuncionarios) {
		boolean resposta = false;
		List<RubricaSomaIrfFuncionario> lista = reposytory.findByIdCodigoFkAndIdAnoMesFkAndIdFuncionarioFk( rubricaSomaIrfCodigo, anoMes, PessoaFuncionarios); 
	...
	public void herdarDeUmMesParaOOutro(Long anoMesInicial, Long anoMesFinal) {
		...
		List<RubricaSomaIrfFuncionario> listaInicial = buscarPorMesExato(anoMesService.buscarPorId(anoMesInicial)); 
		List<RubricaSomaIrfFuncionario> listaFinal = buscarPorMesExato(anoMesService.buscarPorId(anoMesFinal));
		
		if( (!listaInicial.isEmpty())  &&  (listaFinal.isEmpty()) ) {
			for(int i=0;i<listaInicial.size();i++) {
				RubricaSomaIrfFuncionario f = new RubricaSomaIrfFuncionario();
				f.setId(null);
				...
				f.setObs(listaInicial.get(i).getObs());
	...
	public ByteArrayInputStream exportarExcel(List<RubricaSomaIrfFuncionario> lista) {
	...
	public ByteArrayInputStream exportarPdf(List<RubricaSomaIrfFuncionario> lista) {
		...
		try {
			...
			PdfPCell cellTitulo;
			cellTitulo = new PdfPCell(new Phrase("Pessoas com Rubrica Soma IRF", tituloFont) );
