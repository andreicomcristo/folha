...
public class RubricaInsalubridadeService {

	@Autowired
	private RubricaInsalubridadeReposytory reposytory;
	
	@Autowired
	private AnoMesService anoMesService;
	

	public void salvar(RubricaInsalubridade rubricaInsalubridade) {
		// TODO Auto-generated method stub
		reposytory.save(rubricaInsalubridade);
	}

	public void editar(RubricaInsalubridade rubricaInsalubridade) {
		// TODO Auto-generated method stub
		reposytory.save(rubricaInsalubridade);
	}
	...
	public RubricaInsalubridade buscarPorId(Long id) {
		// TODO Auto-generated method stub
		return reposytory.findById(id).get();
	}

	@Transactional(readOnly = true)
	public List<RubricaInsalubridade> buscarTodos() {
		// TODO Auto-generated method stub
		return reposytory.findAllByOrderByIdAnoMesFkNomeAnoMesDesc();
	}
	
	@Transactional(readOnly = true)
	public List<RubricaInsalubridade> buscarPorMesExato(AnoMes anoMes) {
		return reposytory.findByIdAnoMesFkOrderByIdAnoMesFkNomeAnoMesDesc(anoMes);
	}
	
	@Transactional(readOnly = true)
	public List<RubricaInsalubridade> buscarPorNome(String nome) {
		return reposytory.findByIdAnoMesFkNomeAnoMesContainingOrderByIdAnoMesFkNomeAnoMesDesc(nome);
	}
	
	public Page<RubricaInsalubridade> findPaginated(int pageNo, int pageSize) {
	...
	public void herdarDeUmMesParaOOutro(Long anoMesInicial, Long anoMesFinal) {
		...
		List<RubricaInsalubridade> listaInicial = buscarPorMesExato(anoMesService.buscarPorId(anoMesInicial)); 
		List<RubricaInsalubridade> listaFinal = buscarPorMesExato(anoMesService.buscarPorId(anoMesFinal));
		
		if( (!listaInicial.isEmpty())  &&  (listaFinal.isEmpty()) ) {
			for(int i=0;i<listaInicial.size();i++) {
				RubricaInsalubridade f = new RubricaInsalubridade();
				f.setId(null);
	...
	public ByteArrayInputStream exportarExcel(List<RubricaInsalubridade> lista) {
	...
	public ByteArrayInputStream exportarPdf(List<RubricaInsalubridade> lista) {
