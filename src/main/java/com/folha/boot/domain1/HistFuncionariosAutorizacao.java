...
@Entity(name="hist_funcionarios_autorizacao")
public class HistFuncionariosAutorizacao implements Serializable {
    ...
    @JoinColumn(name="id_autorizacao_fk", nullable=false)
     ...
     */
    public void setAutorizacoes(Autorizacoes aAutorizacoes) {
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosAutorizacao.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosAutorizacao and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosAutorizacao)) {
            return false;
        }
        HistFuncionariosAutorizacao that = (HistFuncionariosAutorizacao) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosAutorizacao.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosAutorizacao)) return false;
        return this.equalKeys(other) && ((HistFuncionariosAutorizacao)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosAutorizacao |");
