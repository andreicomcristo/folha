...
@Entity(name="pessoa_documentos_reservista")
public class PessoaDocumentosReservista implements Serializable {
    ...
    /**
     * Compares the key for this instance with another PessoaDocumentosReservista.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class PessoaDocumentosReservista and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof PessoaDocumentosReservista)) {
            return false;
        }
        PessoaDocumentosReservista that = (PessoaDocumentosReservista) other;
    ...
    /**
     * Compares this instance with another PessoaDocumentosReservista.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof PessoaDocumentosReservista)) return false;
        return this.equalKeys(other) && ((PessoaDocumentosReservista)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[PessoaDocumentosReservista |");
