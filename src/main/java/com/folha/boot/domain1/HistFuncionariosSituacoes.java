...
@Entity(name="hist_funcionarios_situacoes")
public class HistFuncionariosSituacoes implements Serializable {
    ...
    @ManyToOne(optional=false)
    @JoinColumn(name="id_situacao_fk", nullable=false)
    ...
    /**
     * Access method for situacoes.
     *
     * @return the current value of situacoes
     */
    ...
    /**
     * Setter method for situacoes.
     *
     * @param aSituacoes the new value for situacoes
     */
    public void setSituacoes(Situacoes aSituacoes) {
        situacoes = aSituacoes;
    }

    /**
     * Compares the key for this instance with another HistFuncionariosSituacoes.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosSituacoes and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosSituacoes)) {
            return false;
        }
        HistFuncionariosSituacoes that = (HistFuncionariosSituacoes) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosSituacoes.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosSituacoes)) return false;
        return this.equalKeys(other) && ((HistFuncionariosSituacoes)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosSituacoes |");
