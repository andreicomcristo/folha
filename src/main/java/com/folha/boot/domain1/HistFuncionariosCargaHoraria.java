...
@Entity(name="hist_funcionarios_carga_horaria")
public class HistFuncionariosCargaHoraria implements Serializable {
    ...
    @JoinColumn(name="id_carga_horaria_semanal_fk", nullable=false)
    ...
    /**
     * Access method for cargaHorariaSemanal.
     *
     * @return the current value of cargaHorariaSemanal
     */
    ...
    /**
     * Setter method for cargaHorariaSemanal.
     *
     * @param aCargaHorariaSemanal the new value for cargaHorariaSemanal
     */
    public void setCargaHorariaSemanal(CargaHorariaSemanal aCargaHorariaSemanal) {
        cargaHorariaSemanal = aCargaHorariaSemanal;
    }
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosCargaHoraria.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosCargaHoraria and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosCargaHoraria)) {
            return false;
        }
        HistFuncionariosCargaHoraria that = (HistFuncionariosCargaHoraria) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosCargaHoraria.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosCargaHoraria)) return false;
        return this.equalKeys(other) && ((HistFuncionariosCargaHoraria)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosCargaHoraria |");
