...
@Entity(name="hist_unidades_natureza_juridica")
public class HistUnidadesNaturezaJuridica implements Serializable {
    ...
    /**
     * Access method for unidadesNaturezaJuridica.
     *
     * @return the current value of unidadesNaturezaJuridica
     */
    public UnidadesNaturezaJuridica getUnidadesNaturezaJuridica() {
        return unidadesNaturezaJuridica;
    }

    /**
     * Setter method for unidadesNaturezaJuridica.
     *
     * @param aUnidadesNaturezaJuridica the new value for unidadesNaturezaJuridica
     */
    public void setUnidadesNaturezaJuridica(UnidadesNaturezaJuridica aUnidadesNaturezaJuridica) {
        unidadesNaturezaJuridica = aUnidadesNaturezaJuridica;
    }

    /**
     * Compares the key for this instance with another HistUnidadesNaturezaJuridica.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistUnidadesNaturezaJuridica and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistUnidadesNaturezaJuridica)) {
            return false;
        }
        HistUnidadesNaturezaJuridica that = (HistUnidadesNaturezaJuridica) other;
    ...
    /**
     * Compares this instance with another HistUnidadesNaturezaJuridica.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistUnidadesNaturezaJuridica)) return false;
        return this.equalKeys(other) && ((HistUnidadesNaturezaJuridica)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistUnidadesNaturezaJuridica |");
