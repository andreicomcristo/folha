...
@Entity(name="hist_funcionarios_classe")
public class HistFuncionariosClasse implements Serializable {
    ...
    @JoinColumn(name="id_classe_fk", nullable=false)
    ...
    /**
     * Access method for classes.
     *
     * @return the current value of classes
     */
     ...
     *
     * @param aClasses the new value for classes
     */
    public void setClasses(Classes aClasses) {
        classes = aClasses;
    }
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosClasse.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosClasse and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosClasse)) {
            return false;
        }
        HistFuncionariosClasse that = (HistFuncionariosClasse) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosClasse.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosClasse)) return false;
        return this.equalKeys(other) && ((HistFuncionariosClasse)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosClasse |");
