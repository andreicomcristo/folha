...
@Entity(name="hist_funcionarios_unidade_atuacao")
public class HistFuncionariosUnidadeAtuacao implements Serializable {
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosUnidadeAtuacao.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosUnidadeAtuacao and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosUnidadeAtuacao)) {
            return false;
        }
        HistFuncionariosUnidadeAtuacao that = (HistFuncionariosUnidadeAtuacao) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosUnidadeAtuacao.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosUnidadeAtuacao)) return false;
        return this.equalKeys(other) && ((HistFuncionariosUnidadeAtuacao)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosUnidadeAtuacao |");
