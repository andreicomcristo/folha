...
@Entity(name="hist_funcionarios_niveis_carreira")
public class HistFuncionariosNiveisCarreira implements Serializable {
    ...
    @Column(name="motivo_cadastro", length=500)
    ...
    /**
     * Access method for niveisCarreira.
     *
     * @return the current value of niveisCarreira
     */
    ...
    /**
     * Setter method for niveisCarreira.
     *
     * @param aNiveisCarreira the new value for niveisCarreira
     */
    public void setNiveisCarreira(NiveisCarreira aNiveisCarreira) {
        niveisCarreira = aNiveisCarreira;
    }
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosNiveisCarreira.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosNiveisCarreira and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosNiveisCarreira)) {
            return false;
        }
        HistFuncionariosNiveisCarreira that = (HistFuncionariosNiveisCarreira) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosNiveisCarreira.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosNiveisCarreira)) return false;
        return this.equalKeys(other) && ((HistFuncionariosNiveisCarreira)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosNiveisCarreira |");
