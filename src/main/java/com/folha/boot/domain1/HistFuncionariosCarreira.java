...
@Entity(name="hist_funcionarios_carreira")
public class HistFuncionariosCarreira implements Serializable {
    ...
    @ManyToOne(optional=false)
    @JoinColumn(name="id_carreira_fk", nullable=false)
    ...
    /**
     * Access method for carreiras.
     *
     * @return the current value of carreiras
     */
    ...
    /**
     * Setter method for carreiras.
     *
     * @param aCarreiras the new value for carreiras
     */
    public void setCarreiras(Carreiras aCarreiras) {
        carreiras = aCarreiras;
    }
    ...
    /**
     * Compares the key for this instance with another HistFuncionariosCarreira.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosCarreira and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosCarreira)) {
            return false;
        }
        HistFuncionariosCarreira that = (HistFuncionariosCarreira) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosCarreira.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosCarreira)) return false;
        return this.equalKeys(other) && ((HistFuncionariosCarreira)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosCarreira |");
