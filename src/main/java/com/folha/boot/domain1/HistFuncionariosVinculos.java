...
@Entity(name="hist_funcionarios_vinculos")
public class HistFuncionariosVinculos implements Serializable {
    ...
    @ManyToOne(optional=false)
    @JoinColumn(name="id_vinculo_fk", nullable=false)
    ...
    /**
     * Access method for vinculos.
     *
     * @return the current value of vinculos
     */
    ...
    /**
     * Setter method for vinculos.
     *
     * @param aVinculos the new value for vinculos
     */
    public void setVinculos(Vinculos aVinculos) {
        vinculos = aVinculos;
    }

    /**
     * Compares the key for this instance with another HistFuncionariosVinculos.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistFuncionariosVinculos and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistFuncionariosVinculos)) {
            return false;
        }
        HistFuncionariosVinculos that = (HistFuncionariosVinculos) other;
    ...
    /**
     * Compares this instance with another HistFuncionariosVinculos.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistFuncionariosVinculos)) return false;
        return this.equalKeys(other) && ((HistFuncionariosVinculos)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistFuncionariosVinculos |");
