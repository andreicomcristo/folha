...
@Entity(name="hist_unidades_regime")
public class HistUnidadesRegime implements Serializable {
    ...
    @ManyToOne(optional=false)
    @JoinColumn(name="id_unidade_regime_fk", nullable=false)
    ...
    /**
     * Access method for unidadesRegime.
     *
     * @return the current value of unidadesRegime
     */
    ...
    /**
     * Setter method for unidadesRegime.
     *
     * @param aUnidadesRegime the new value for unidadesRegime
     */
    public void setUnidadesRegime(UnidadesRegime aUnidadesRegime) {
        unidadesRegime = aUnidadesRegime;
    }
    ...
    /**
     * Compares the key for this instance with another HistUnidadesRegime.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class HistUnidadesRegime and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof HistUnidadesRegime)) {
            return false;
        }
        HistUnidadesRegime that = (HistUnidadesRegime) other;
    ...
    /**
     * Compares this instance with another HistUnidadesRegime.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HistUnidadesRegime)) return false;
        return this.equalKeys(other) && ((HistUnidadesRegime)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[HistUnidadesRegime |");
